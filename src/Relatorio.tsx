      ...
      <section className='mt-[3rem] mb-[2rem] flex flex-col justify-center items-center gap-[2.63rem]'>
        <div className="flex flex-row items-center justify-between w-[83vw]">
          ...
          <div className="flex flex-row gap-[2.25rem]">
            ...
            <button className="flex items-center gap-3 px-[0.9375rem] rounded-[0.375rem] border-[#969b96] border-2 py-[0.625rem] flex-row bg-[linear-gradient(139deg,#184047_-40.56%,#F89900_279.19%)]">
              <img className="w-[1.25rem]" src="/print.svg" alt="" />
              <a className="font-inter text-white font-normal" href="">Exportar relatório para PDF</a>
            </button>
          </div>
        </div>
