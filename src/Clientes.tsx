...
export default function Clientes() {
  ...
  const listaClientes = clientes.map((cliente: any) => (
    <ClienteItem
      key={cliente.id}
      cliente={cliente}
      clientes={clientes}
      ...
      <section className='mt-[3rem] mb-[2rem] flex flex-col justify-center items-center'>
        <div className='w-[85.6875rem] flex flex-col gap-[1.44rem]'>
          <div className='flex flex-row items-center justify-between'>
            ...
            <button onClick={() => setOpenAdicionarCliente(true)} className='flex text-white items-center justify-center rounded-[0.5rem] bg-[linear-gradient(139deg,_#114114_-40.56%,_#00C000_279.19%)] w-[12rem] h-[2.7rem] text-[1.25rem] font-roboto font-normal'>Adicionar</button>
          </div>
