...
export default function Receitas() {
  ...
  async function incluirReceitaComItens() {
    ...
    const categoriaCabecalho =
      !formularioCabecalho.categoria || formularioCabecalho.categoria.trim() === ""
        ? "Não definido"
        : formularioCabecalho.categoria;

    const payloadCabecalho = {
      descricao: formularioCabecalho.descricao || "Venda",
      valor: totalItens,
      categoria: categoriaCabecalho,
  ...
  const receitasFiltradas = filtroCategoria
    ? receitas.filter((receita: any) => {
      const categoria = (receita as any).categoria ?? "Não definido";
        ...
        <div className="w-[85.6875rem] flex flex-col gap-[1.44rem]">
          ...
          <div className="bg-[#F5F5F5] px-[1.62rem] py-[1.93rem] rounded-[1rem] flex flex-col gap-[1.44rem]">
            ...
            <div className="grid grid-cols-6 font-inter text-[1rem] font-normal mt-4 px-[1.06rem]">
              ...
              <h2 className="text-center">Itens Vendidos</h2>
