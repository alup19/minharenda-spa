...
export default function Despesas() {
  ...
  return (
    <>
      ...
      <section className="mt-[3rem] mb-[2rem] flex flex-col justify-center items-center">
        <div className="w-[85.6875rem] flex flex-col gap-[1.44rem]">
          <div className="flex flex-row items-center justify-between">
            ...
            <button
              onClick={() => setOpenAdicionarDespesas(true)}
            ...
            <div className="flex flex-col gap-[1.44rem]">
              <div className="flex flex-row justify-between">
                <div className="flex flex-row items-center gap-[1.125rem]">
                  ...
                  <h3 className="text-[1.5rem] font-inter font-semibold">
                    Setembro
                  </h3>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    id="filtro_categoria"
                  // Filtro por categoria você ativa futuramente
                  />
                </div>
              </div>
            </div>
      ...
      <Modal
        open={openAdicionarDespesas}
        onClose={() => setOpenAdicionarDespesas(false)}
      >
        <div className="container">
          ...
          <form
            onSubmit={handleSubmit(incluirDespesa)}
          ...
          >
            ...
            <div className="flex gap-4">
              <button
                type="button"
                onClick={() => setOpenAdicionarDespesas(false)}
